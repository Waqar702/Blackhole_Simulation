...
This demo has working camera controls and better light ray bending.
"""
...
class CameraAwareDemo:
    """Camera aware demo with working controls and better ray bending."""
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Camera Aware Demo - Working Controls", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def setup_gpu_pipeline(self):
        ...
        # Load camera aware compute shader
        compute_source = open('assets/geodesic_camera_aware.comp', 'r').read()
    ...
    def setup_scene(self):
        ...
        print(f"Camera radius: {self.camera_radius:.2e}")
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Camera Aware Demo - Working Controls")
            print("=" * 70)
            print("This demo has working camera controls and better ray bending!")
            print("")
            print("Controls:")
            ...
            print("- Multiple light rays with better curvature")
            print("- Starfield background")
            print("- Working camera movement!")
            print("=" * 70)
