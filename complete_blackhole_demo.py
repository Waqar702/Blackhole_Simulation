#!/usr/bin/env python3
"""
Complete Black Hole Demo with Light Rays

This demo shows both the black hole AND light rays with working camera controls.
"""
...
class CompleteBlackHoleDemo:
    """Complete black hole demo with light rays and working camera controls."""
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Complete Black Hole Demo - Rays + Black Hole", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def setup_gpu_pipeline(self):
        ...
        # Load complete compute shader (black hole + rays)
        compute_source = open('assets/geodesic_complete.comp', 'r').read()
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Complete Black Hole Demo - Rays + Black Hole")
            print("=" * 70)
            print("This demo shows BOTH light rays AND the black hole!")
            print("")
            print("Controls:")
            ...
            print("- Accretion disk (orange/red line)")
            print("- Multiple light rays curving around")
...
def main():
    """Main demo function."""
    demo = CompleteBlackHoleDemo(1200, 900)
    demo.run()
