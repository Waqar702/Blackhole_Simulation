#!/usr/bin/env python3
"""
Debug Visual Demo - Closer Camera

This demo positions the camera much closer to the black hole to ensure we can see it.
"""
...
class DebugVisualDemo:
    """Debug visual demo with closer camera."""
    ...
    def __init__(self, width=1200, height=900):
        ...
        # Camera parameters - MUCH CLOSER to black hole
        self.camera_radius = 1e11  # Much closer!
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Debug Visual Demo - Closer Camera", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def setup_gpu_pipeline(self):
        ...
        # Load debug visual compute shader
        compute_source = open('assets/geodesic_debug_visual.comp', 'r').read()
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Debug Visual Demo - Closer Camera")
            print("=" * 70)
            print("This demo positions the camera MUCH closer to the black hole!")
            print("")
            print("Controls:")
