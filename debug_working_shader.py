#!/usr/bin/env python3
"""
Debug the working black hole shader to see what it's actually producing.
"""
...
def debug_working_shader():
    """Debug the working black hole shader."""
    print("🔍 Debugging Working Black Hole Shader")
    print("=" * 50)
    ...
    window = glfw.create_window(800, 600, "Debug Working Shader", None, None)
    if not window:
        glfw.terminate()
    ...
    if num_non_black > 0:
        print("✅ Working shader is producing output!")
        ...
        print(f"Non-zero pixels: {num_non_zero}")
        
    else:
        print("❌ Working shader is not producing any output")
        return False
