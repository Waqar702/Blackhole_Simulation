...
This demo directly draws the black hole and disk without complex ray tracing.
"""
...
class DirectDrawDemo:
    """Direct draw demo that should definitely show the black hole."""
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Direct Draw Demo - Black Hole + Rays", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def setup_gpu_pipeline(self):
        ...
        # Load direct draw compute shader
        compute_source = open('assets/geodesic_direct_draw.comp', 'r').read()
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Direct Draw Demo - Black Hole + Rays")
            print("=" * 70)
            print("This demo directly draws the black hole and disk!")
            print("")
            print("Controls:")
