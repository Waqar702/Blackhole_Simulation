#!/usr/bin/env python3
"""
Final Working Black Hole Demo

This demo shows the actual black hole simulation with correct camera positioning.
"""
...
class FinalWorkingBlackHole:
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Final Working Black Hole Simulation", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Final Working Black Hole Simulation")
            print("=" * 50)
...
def main():
    """Main demo function."""
    demo = FinalWorkingBlackHole(800, 600)
    demo.run()
