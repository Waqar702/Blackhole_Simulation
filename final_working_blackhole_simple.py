#!/usr/bin/env python3
"""
Final Working Black Hole Demo with Simple Shader

This demo shows the actual black hole simulation using a simplified shader.
"""
...
class FinalWorkingBlackHoleSimple:
    """Final working black hole demo with simple shader."""
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Final Working Black Hole - Simple Shader", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def setup_gpu_pipeline(self):
        ...
        # Load SIMPLE compute shader (this one works!)
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Final Working Black Hole Simulation - Simple Shader")
            print("=" * 60)
...
def main():
    """Main demo function."""
    demo = FinalWorkingBlackHoleSimple(800, 600)
    demo.run()
