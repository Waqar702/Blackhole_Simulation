#!/usr/bin/env python3
"""
Light Ray Tracing Demo

This demo shows individual light rays curving around the black hole.
"""
...
class LightRayDemo:
    """Light ray tracing demo showing curved light paths."""
    
    def __init__(self, width=1200, height=900):  # Larger window
        """Initialize the demo."""
        self.width = width
        self.height = height
        self.window = None
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Light Ray Tracing Demo - Black Hole Lensing", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def setup_gpu_pipeline(self):
        ...
        compute_source = open('assets/geodesic_rays.comp', 'r').read()
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Light Ray Tracing Demo - Black Hole Lensing")
            print("=" * 70)
            print("This demo shows light rays curving around the black hole!")
            print("")
            print("Controls:")
            ...
            print("- Light rays entering from the left")
...
def main():
    """Main demo function."""
    demo = LightRayDemo(1200, 900)  # Larger window
    demo.run()
