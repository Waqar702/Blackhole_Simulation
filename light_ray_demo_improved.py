#!/usr/bin/env python3
"""
Improved Light Ray Tracing Demo

This demo shows multiple light rays curving around the black hole with better visualization.
"""
...
class LightRayDemoImproved:
    """Improved light ray tracing demo showing multiple curved light paths."""
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Improved Light Ray Tracing - Multiple Rays", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def key_callback(self, window, key, scancode, action, mods):
        ...
        if action == glfw.PRESS and key == glfw.KEY_ESCAPE:
            ...
            print("Ray visualization toggled")
    ...
    def scroll_callback(self, window, xoffset, yoffset):
        ...
        # Clamp radius
        self.camera_radius = max(1e10, min(1e13, self.camera_radius))
    ...
    def setup_gpu_pipeline(self):
        ...
        # Load improved ray tracing compute shader
        compute_source = open('assets/geodesic_rays_improved.comp', 'r').read()
        ...
        # Create buffers and texture (larger resolution)
        self.gpu_pipeline.create_buffers()
        self.gpu_pipeline.create_output_texture(800, 600)  # Higher resolution
    ...
    def render(self):
        ...
        self.gpu_pipeline.dispatch_compute(800, 600)  # Higher resolution
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Improved Light Ray Tracing Demo - Multiple Rays")
            print("=" * 70)
            print("This demo shows MULTIPLE light rays curving around the black hole!")
            print("")
            print("Controls:")
            print("- Mouse drag: Orbit around black hole")
            print("- Mouse wheel: Zoom in/out")
            print("- R key: Reset camera")
            print("- SPACE: Toggle ray visualization")
            print("- ESC: Exit")
            print("")
            print("You should see:")
            print("- Multiple light rays entering from the left")
            print("- Rays curving around the black hole")
            print("- Gravitational lensing effects")
            print("- Black hole and accretion disk")
            print("=" * 70)
...
def main():
    """Main demo function."""
    demo = LightRayDemoImproved(1200, 900)
    demo.run()
