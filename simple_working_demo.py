#!/usr/bin/env python3
"""
Simple Working Black Hole Demo

This demo uses a simplified shader that should definitely show the black hole and disk.
"""
...
class SimpleWorkingDemo:
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Simple Working Black Hole Demo", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def setup_gpu_pipeline(self):
        ...
        # Load simple working compute shader
        compute_source = open('assets/geodesic_simple_working.comp', 'r').read()
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Simple Working Black Hole Demo")
            print("=" * 70)
            print("This demo should definitely show the black hole and disk!")
            print("")
            print("Controls:")
...
def main():
    """Main demo function."""
    demo = SimpleWorkingDemo(1200, 900)
    demo.run()
