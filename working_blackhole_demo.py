#!/usr/bin/env python3
"""
Working Black Hole Visualization Demo
...
class WorkingBlackHoleDemo:
    """Working black hole visualization demo with GPU rendering."""
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Working Black Hole GPU Visualization", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def key_callback(self, window, key, scancode, action, mods):
        ...
        if action == glfw.PRESS:
            if key == glfw.KEY_ESCAPE:
                ...
                # Reset camera
                self.camera = Camera(
                    radius=5e10,  # Closer to black hole
                    azimuth=0.0,
                    elevation=np.pi/2.0,
                )
    ...
    def setup_scene(self):
        ...
        # Create camera - start closer to the black hole
        self.camera = Camera(
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Working Black Hole GPU Visualization Demo")
            print("=" * 60)
            print("Controls:")
            print("  ESC - Exit")
...
def main():
    """Main demo function."""
    demo = WorkingBlackHoleDemo(800, 600)
    demo.run()
