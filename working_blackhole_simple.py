#!/usr/bin/env python3
"""
Working Black Hole Demo with Simple Rendering

This demo uses the simple fragment shader to ensure we can see the output.
"""
...
class WorkingBlackHoleSimple:
    ...
    def create_window(self):
        ...
        self.window = glfw.create_window(
            ...
            "Working Black Hole - Simple Rendering", None, None
        )
        if not self.window:
            glfw.terminate()
    ...
    def run(self):
        ...
        try:
            ...
            print("\n🌌 Working Black Hole Demo - Simple Rendering")
            print("=" * 50)
...
def main():
    """Main demo function."""
    demo = WorkingBlackHoleSimple(800, 600)
    demo.run()
